...
const sendEmailWithContentAndLinks =
  async (accessToken: string, year: number, landlordNumber: number, email: string, name: string, contactName: string,
         overviewLink: string, emailContents: string) => {
  console.log('sendEmail year: %s, landlordNumber: %s, accessToken: %s', year, landlordNumber, accessToken);
